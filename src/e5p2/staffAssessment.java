...
public class staffAssessment {
	...
	@Test(testName = "staffAssessment", dataProvider = "getExcelData")
	public void staffAssessment(String studentID, String courseName) throws InterruptedException, Exception {
		...
		driver.findElement(By.xpath("//*[@id=\"RequirementSection_Requirement_VerificationStatus\"]")).sendKeys(
				Keys.TAB, Keys.TAB, "2018", Keys.TAB, "Complete Secondary", Keys.ENTER, Keys.ENTER, Keys.TAB, Keys.TAB);
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"RequirementSection_Requirement_VerificationStatus\"]")).sendKeys(
				Keys.TAB, Keys.TAB, "2018", Keys.TAB, "Complete Secondary", Keys.ENTER, Keys.ENTER, Keys.TAB, Keys.TAB);
		Thread.sleep(1000);
